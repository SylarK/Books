...
#   A Binary Search Tree (BST) give us two choices: left or right, less than or greater than, 0 or 1.
#   Anything that is stored in a BST must be comparable (less than < , greather than >, equal to == )
